...
say "\nNot koha-plugin-edifact-library-bound-inc, exiting" && exit 0 unless $repo eq "koha-plugin-edifact-library-bound-inc";
...
foreach my $repo (@repos) {
    next if $repo eq 'koha-plugin-edifact-library-bound-inc';
    next if $repo eq 'koha-plugin-edifact-library-bound-inc-docs';
