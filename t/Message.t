...
use Koha::Plugin::Com::ByWaterSolutions::EdifactLibraryBoundInc::Edifact;
...
my $edi = Koha::Plugin::Com::ByWaterSolutions::EdifactLibraryBoundInc::Edifact->new(
    { transmission => $invoic } );
my ($msg) = @{ $edi->message_array };
isa_ok( $msg,
    'Koha::Plugin::Com::ByWaterSolutions::EdifactLibraryBoundInc::Edifact::Message',
...
subtest 'shipment_charge sums per plugin shipment_charges_moa_* settings' => sub {
    ...
    my $stub_plugin = sub {
        ...
        bless { _settings => \%settings },
            'Koha::Plugin::Com::ByWaterSolutions::EdifactLibraryBoundInc::TestStub';
    };

    {
        no strict 'refs';
        *{'Koha::Plugin::Com::ByWaterSolutions::EdifactLibraryBoundInc::TestStub::retrieve_data'}
