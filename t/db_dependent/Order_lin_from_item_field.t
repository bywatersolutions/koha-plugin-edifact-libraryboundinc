...
use Koha::Database;
use Koha::Items;
use Koha::Plugin::Com::ByWaterSolutions::EdifactLibraryBoundInc;
use Koha::Plugin::Com::ByWaterSolutions::EdifactLibraryBoundInc::Edifact::Order;
...
sub _new_plugin {
    my (%settings) = @_;
    my $plugin = Koha::Plugin::Com::ByWaterSolutions::EdifactLibraryBoundInc->new(
...
sub _build_edifact_order {
    ...
    return Koha::Plugin::Com::ByWaterSolutions::EdifactLibraryBoundInc::Edifact::Order
        ->new(
        {
