package Koha::Plugin::Com::ByWaterSolutions::EdifactLibraryBoundInc::Edifact::Transport;
...
sub download_messages {
    ...
    my $skip_previously_downloaded_files = $self->{plugin}->retrieve_data('skip_previously_downloaded_files');
